 <div class="justify-content-center px-auto">


 <!-- Main Sidebar Container -->
 <aside class="main-sidebar sidebar-light-primary elevation-4 position-relative">
    <!-- Brand Logo -->
    <a href="../../index3.html" class="brand-link">
      <img src="Assets/Images/logo/logo_amik.png" alt="Logo Amik" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="Assets/Admin_lte/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Admin 1 AMIK</a>
        </div>
      </div>
